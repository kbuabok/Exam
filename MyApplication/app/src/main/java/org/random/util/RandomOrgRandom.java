...
public class RandomOrgRandom extends Random {
	...
	/** Blocking implementation of {@link Random#nextInt(int)} using RANDOM.ORG's RNG service.
	 ** 
	...
	/** Blocking implementation of {@link Random#next(int)} using RANDOM.ORG's RNG service.
	 ** 
	 ** @see Random#next(int)
	 **
	 ** @throws NoSuchElementException if a number couldn't be retrieved.
